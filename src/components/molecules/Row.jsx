...
const Row = ({ className = '', children, justify, align, flexDirection = [], flexWrap = [], ...htmlAttributes }) => {
    const rowClassNames = classNames('vdp-row', {
        ...
        [getFlexDirectionClass(flexDirection[0], 'mobile')]: Array.isArray(flexWrap) && flexDirection[0],
        [getFlexDirectionClass(flexDirection[1], 'tablet')]: Array.isArray(flexWrap) && flexDirection[1],
        [getFlexDirectionClass(flexDirection[2], 'desktop')]: Array.isArray(flexWrap) && flexDirection[2],
